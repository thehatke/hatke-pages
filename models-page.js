...
(function () {
  ...
  var BRANDS = [[/ipad|galaxy tab|\btab\b|\bpad\b/, "Tablets"], [/iqoo/, "iQOO"], [/iphone|apple/, "Apple"], [/samsung|galaxy/, "Samsung"], [/oneplus/, "OnePlus"], [/pixel|google/, "Google"], [/motorola|moto /, "Motorola"], [/nothing|cmf/, "Nothing"], [/oppo/, "Oppo"], [/vivo/, "Vivo"], [/redmi|xiaomi|poco/, "Xiaomi"], [/realme/, "Realme"], [/infinix/, "Infinix"], [/tecno/, "Tecno"], [/honor/, "Honor"], [/lava/, "Lava"]];
  var ORDER = ["Apple", "Samsung", "OnePlus", "Google", "Motorola", "Nothing", "Oppo", "Vivo", "Xiaomi", "Realme", "iQOO", "Infinix", "Tecno", "Honor", "Lava", "Tablets"];
